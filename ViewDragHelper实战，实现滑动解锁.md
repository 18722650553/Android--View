...
![ViewDragHelper实战，实现滑动解锁.gif](https://upload-images.jianshu.io/upload_images/1641428-a80445edabc3bec3.gif?imageMogr2/auto-orient/strip)
...
1. tryCaptureView为判断子View是否可以拽托
2. clampViewPositionHorizontal()则是横向拽托子View时回调，返回可以拽托到的位置。
3. clampViewPositionVertical则是纵向拽托。
